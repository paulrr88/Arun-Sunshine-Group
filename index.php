      ...
      <!--Content begins #content--><div class="twelve columns background-orange" id="content">
        ...
        <div class="row"><!--Activities & Events columns-->
          <div class="eight columns offset-by-two content-box-col-yellow"><!--Activities-->
            ...
            <p class="centre content-box-p-big"><strong><?php perch_content('Activities list'); ?></strong></p>

            <div class="spacer"></div>

            <div class="five columns offset-by-one">
              <?php perch_content('Activities image 1'); ?>
            </div>
            <div class="five columns">
              <?php perch_content('Activities image 2'); ?>
            </div>

            <div class="spacer"></div>

            <div class="five columns offset-by-one">
              <?php perch_content('Activities image 3'); ?>
            </div>
            <div class="five columns">
              <?php perch_content('Activities image 4'); ?>
            </div>
          ...
          <div class="eight columns offset-by-two content-box-col-yellow"><!--Events-->
            ...
            <p class="centre content-box-p-big"><strong><?php perch_content('Events outings list'); ?></strong></p>

            <div class="spacer"></div>

            <div class="five columns offset-by-one">
              <?php perch_content('Events image 1'); ?>
            </div>
            <div class="five columns">
              <?php perch_content('Events image 2'); ?>
            </div>

            <div class="spacer"></div>

            <div class="five columns offset-by-one">
              <?php perch_content('Events image 3'); ?>
            </div>
            <div class="five columns">
              <?php perch_content('Events image 4'); ?>
            </div>
        ...
        <div class="row"><!--Membership & Volunteers columns-->
          <div class="five columns offset-by-one content-box-col-yellow"><!--Membership-->
            ...
            <p class="centre content-box-p"><strong>Members must be aged 18 years or over and are invited to contribute <em><?php perch_content('Membership cost per meeting'); ?></em> per meeting plus a yearly membership fee of <em><?php perch_content('Membership cost per year'); ?></em>.</p>
          </div>
          ...
          <div class="four columns offset-by-one content-box-col-yellow "><!--Volunteers-->
            ...
            <p class="centre content-box-p"><strong>All of our volunteers:
              <ul class="body">
                <?php perch_content('Volunteers list'); ?>
              </ul>
            </strong></p>
          </div>
        </div>
        ...
        <div><!--Four side-by-side images-->
          <div class="content-box-img-fullwidth-25">
            <?php perch_content('Bottom strip image 1'); ?>
          </div>
          <div class="content-box-img-fullwidth-25">
            <?php perch_content('Bottom strip image 2'); ?>
          </div>
          <div class="content-box-img-fullwidth-25">
            <?php perch_content('Bottom strip image 3'); ?>
          </div>
          <div class="content-box-img-fullwidth-25">
            <?php perch_content('Bottom strip image 4'); ?>
          </div>
        </div>
        ...
        <div class="twelve columns background-yellow"><!--Box with extra info-->
          ...
          <p class="centre content-box-p-big"><strong>Contact: Derek Moore MBE. TEL <?php perch_content('Phone number'); ?></strong></p>
